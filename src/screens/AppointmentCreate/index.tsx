...
export function AppointmentCreate() {
  ...
  async function handleSaveAppointment() {
    ...
    const appointments = localAppointments ? JSON.parse(localAppointments) : []

    await AsyncStorage.setItem(APPOINTMENTS_COLLECTION, JSON.stringify([...appointments, newAppointment]))
